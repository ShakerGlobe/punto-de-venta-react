...
export const FAQHero = () => {
    ...
    return (
        ...
        >
            {/* 1. FONDO DINÁMICO: Líneas de Luz Verde (Flujo de Consultas) */}
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                {/* Resplandor Central (Verde Nedimi) */}
            ...
            <div className="max-w-7xl mx-auto w-full relative z-10 flex flex-col items-center text-center">
                ...
                >
                    Todo lo que necesitas saber sobre <span className="text-white font-normal underline decoration-[#00C1A3]/50 decoration-2 underline-offset-4">Nedimi POS</span>. Encuentra soluciones rápidas y despeja tus dudas para potenciar tu negocio hoy mismo.
                </motion.p>
...
const FAQLine = ({ index, total }: { index: number, total: number }) => {
    ...
    const lineWidth = 110 + (index % 4) * 40; 
