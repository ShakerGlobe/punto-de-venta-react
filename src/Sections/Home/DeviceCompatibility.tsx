...
import { Monitor, Smartphone, CheckCircle2, Cpu, Barcode, Sparkles } from "lucide-react";
    ...
    return (
        <section className="relative py-10 md:py-10 bg-white overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                {/* Resplandor verde más concentrado y visibleDetrás de los aparatos */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <div className="relative flex justify-center items-center h-[400px] md:h-[550px] order-2 lg:order-1">
                        ...
                        <motion.div
                            ...
                            className="absolute z-10 w-[90%] md:w-[520px] bg-slate-950 border-[8px] md:border-[10px] border-slate-900 rounded-[2rem] md:rounded-[2.5rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] -translate-x-4 md:-translate-x-8 -translate-y-6 md:-translate-y-10"
                        >
                        ...
                        <motion.div
                            ...
                            className="absolute z-20 w-[140px] md:w-[220px] aspect-[9/19] bg-slate-950 border-[6px] md:border-[8px] border-slate-900 rounded-[2.5rem] md:rounded-[3rem] shadow-[0_40px_80px_-10px_rgba(0,193,163,0.3)] p-1 translate-x-20 translate-y-24 md:translate-x-40 md:translate-y-36"
                        >
