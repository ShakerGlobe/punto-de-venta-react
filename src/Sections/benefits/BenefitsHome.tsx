...
export const BenefitsHome = () => {
    ...
    return (
        <section id="benefits" className="py-20 md:py-32 bg-white relative flex flex-col items-center">
            ...
            {/* --- DESTELLOS AZULES MUY SUAVES --- */}
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
                <div className="absolute top-[10%] left-[-10%] w-[500px] h-[500px] bg-blue-600/5 blur-[120px] rounded-full" />
                <div className="absolute bottom-[10%] right-[-10%] w-[600px] h-[600px] bg-blue-400/5 blur-[150px] rounded-full" />
            </div>
            ...
            <div className="max-w-6xl mx-auto px-6 w-full relative z-10">
                ...
                <div className="text-center mb-20">
                    <span className="text-blue-600 font-black uppercase tracking-[0.2em] text-[10px] bg-blue-50 px-6 py-2 rounded-full border border-blue-100">
                    ...
                    <h2 className="mt-8 text-4xl md:text-7xl font-[1000] text-slate-900 tracking-tighter italic uppercase leading-[0.9]">
                        ...
                        <span className="text-blue-600 underline decoration-blue-100 decoration-8 underline-offset-4">SIN COMPLICACIONES</span>
                    </h2>
                ...
                {/* --- COMPARATIVA SIMPLE (Antes vs Después) --- */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-24">
                    ...
                    {/* Lado Nedimi */}
                    <div className="p-8 md:p-12 rounded-[2rem] bg-blue-600 shadow-xl shadow-blue-600/20 flex flex-col text-white">
                        <div className="flex items-center gap-3 mb-8">
                        ...
                        <ul className="space-y-4">
                            {["Todo se suma solito", "Avisos de mercancía baja", "Ventas rápidas en tu cel"].map((t, i) => (
                                <li key={i} className="flex gap-3 items-center text-white text-sm font-bold uppercase italic">
                                    <Zap size={16} className="text-blue-200 fill-blue-200/20" /> {t}
                                </li>
                            ))}
                        </ul>
                    </div>
                ...
                {/* --- GRID DE BENEFICIOS LIMPIO --- */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
                    {benefits.map((item, i) => (
                        <div 
                            key={i}
                            className="p-8 rounded-[2.5rem] bg-white border border-slate-100 shadow-sm flex flex-col items-center text-center hover:border-blue-200 hover:shadow-md transition-all group"
                        >
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest text-blue-600 bg-blue-50 px-4 py-1 rounded-full">
                                {item.badge}
                            </span>
                        </div>
                    ))}
                ...
                <div className="pt-20 border-t border-slate-100 grid grid-cols-1 md:grid-cols-3 gap-12">
                    {[
                        ...
                        <div key={i} className="flex flex-col items-center">
                            <div className="w-12 h-12 rounded-full bg-blue-600 text-white flex items-center justify-center mb-4 shadow-lg shadow-blue-600/30">
